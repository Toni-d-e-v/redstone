...
namespace WalletConfig
{
    ...
    const std::string_view addressPrefix = "R";

    /* Your coins 'Ticker', e.g. Monero = XMR, Bitcoin = BTC */
    const std::string ticker = "RS";
    ...
    /* The name of service/walletd, the programmatic rpc interface to a
       wallet */
    const std::string walletdName = "red-service";

    /* The full name of your crypto */
    const std::string coinName = std::string(CryptoNote::CRYPTONOTE_NAME);

    /* Where can your users contact you for support? E.g. discord */
    const std::string contactLink = "https://discord.gg/sy7J6UV";

    /* The number of decimals your coin has */
    const uint8_t numDecimalPlaces = CryptoNote::parameters::CRYPTONOTE_DISPLAY_DECIMAL_POINT;

    /* The length of a standard address for your coin */
    const uint16_t standardAddressLength = 96;
    ...
    /**
     * Max size of a post body response - 30MB
     ...
     */
    const size_t maxBodyResponseSize = 1024 * 1024 * 30;
